...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/home/emobilis/PycharmProjects/Trevor Web Portfolio(Week III)'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/home/emobilis/PycharmProjects/Trevor Web Portfolio(Week III)/bin/deactivate.nu'
